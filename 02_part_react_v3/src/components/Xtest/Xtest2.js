...
export default function RadioButtonsGroup() {
  ...
  const selRange = temperatureRange.filter(
    (rangeItem) => rangeItem.range === "-60ºC..85ºC"
  );
  ...
  /* [10,5,20] */
  const selRangeModelsExactStabilityArray = selRangeModelsArray.filter(
    (rangeItem) => rangeItem.stabilityLimit <= 5
  );
